...
class ReadMoreTextHelper extends StatefulWidget {
  ...
  @override
  ReadMoreTextHelperState createState() => ReadMoreTextHelperState();
}
...
class ReadMoreTextHelperState extends State<ReadMoreTextHelper> {
  bool _readMore = true;
