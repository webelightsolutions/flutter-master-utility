...
// Project imports:
import 'package:master_utility/src/intl_mobile/country_picker_dialog.dart';

import './countries.dart';
import './phone_number.dart';

@Deprecated('IntlPhoneField is deprecated. and it will be removed in the next major release.')
    ...
    return TextFormField(
      ...
      onChanged: (value) async {
        ...
        if (widget.autovalidateMode != AutovalidateMode.disabled) {
          validatorMessage = widget.validator?.call(phoneNumber.toString());
        }
    ...
    return Container(
      ...
      child: DecoratedBox(
        ...
        child: InkWell(
          ...
          onTap: widget.enabled ? null : _changeCountry,
        ),
      ),
    );
  }
